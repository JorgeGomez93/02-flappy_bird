...
public:
    ...
    void enter(std::shared_ptr<World> _world = nullptr, std::shared_ptr<Bird> _bird = nullptr, int _score = 0, bool _hard_mode = false, bool invulnerable = false, float time_left = 0) noexcept override;
