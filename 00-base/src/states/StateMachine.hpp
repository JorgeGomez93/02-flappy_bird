...
public:
    ...
    void change_state(const std::string& state_name, std::shared_ptr<World> world = nullptr, std::shared_ptr<Bird> bird = nullptr, int score = 0, bool _hard_mode = false, bool invulnerable = false, float time_left = 0.0f) noexcept;
