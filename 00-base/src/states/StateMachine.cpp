...
void StateMachine::change_state(const std::string& state_name, std::shared_ptr<World> world, std::shared_ptr<Bird> bird, int score, bool _hard_mode, bool invulnerable, float time_left) noexcept
{
    ...
    current_state->enter(world, bird, score, _hard_mode, invulnerable, time_left);
}
